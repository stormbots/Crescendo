...
/**
 * Table of pattern colors for the Blinken light controller, so that colors and patterns can be
 * represented by named values. <br>
 * Enum instances will have a {@link #us()} or {@link #pwm()} method which returns an output value
 * of the appropriate type. These outputs can then be fed to a PWM controller or Servo controller
 * which will control the Blinken.
 *
 * @author stormbots
...
public enum BlinkenPattern {
  ...
  // C12_END_TO_END_BLEND_C2_TO_C1      (1735,0.47),   //  PATTERN  74   //TODO: Possibly incorrect
  // description ; Documentation is odd here
