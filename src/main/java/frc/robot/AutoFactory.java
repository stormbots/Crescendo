...
public class AutoFactory {
    ...
    public PathPlannerPath pathPlannerPath;
    ...
    //     try {
    //         pathPlannerPath = PathPlannerPath.fromPathFile("twoMeterAuto");
    ...
    //     // PPHolonomicDriveController holonomicPathFollowerConfig = new PPHolonomicDriveController(
    ...
    //     //This seems to be the new structure, but with other structural problems, and no ability to test MOI and stuff, 
    //     // not worth bringing up
    //     // RobotConfig = new RobotConfig(
    //     //     Pounds.of(130), 
    //     //     Kilogram.of(magnitude).mult(Pounds), 
    //     //     moduleConfig, 
    //     //     trackwidthMeters)
    //     // ;
    ...
    //     Distance distance = Units.Meters.of(Math.hypot(4.3-0.4, 6.25-5.55));
