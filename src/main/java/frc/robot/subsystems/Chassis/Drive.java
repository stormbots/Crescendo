...
public class Drive extends SubsystemBase {
  ...
  private final ModuleUpdater[] modules = new ModuleUpdater[4]; // FL, FR, BL, BR
  ...
  public Drive(
    ...
    modules[3] = new ModuleUpdater(brModuleIO, 3);
  ...
  OdometryThread.getInstance().start();
    ...
    AutoBuilder.configureHolonomic(
        ...
        new HolonomicPathFollowerConfig(
            DriveConstants.kMaxSpeedMetersPerSecond, DriveRadius, new ReplanningConfig()),
        () ->
