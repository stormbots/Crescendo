...
public class FieldPosition {
  public static final double kOriginOffsetX = 15.98 / 2.0;
  public static final double kOriginOffsetY = 8.120 / 2.0;

  public static final double[] kSpeakerCols = {16.542, 0.0}; // TODO: get speaker cols!!
  public static final double kSpeakerRow = 2.676 + 2.573 + 2.695 - 2.104 - 0.04 - 0.5 + 0.25;
  public static final double kSpeakerHeight = 0; // TODO: get speaker height!!

  public static final Pose3d RedSpeaker =
      new Pose3d(kSpeakerCols[0], kSpeakerRow, kSpeakerHeight, new Rotation3d(0, 0, Math.PI));
  public static final Pose3d BlueSpeaker =
      new Pose3d(kSpeakerCols[1], kSpeakerRow, kSpeakerHeight, new Rotation3d());

  public static final double[] kAmpCols = {0.0, 0.0};
  public static final double kAmpRow = 0.0;
  public static final double kAmpHeight = 0.0;

  public static final Pose3d RedAmp =
      new Pose3d(kAmpCols[0], kAmpRow, kAmpHeight, new Rotation3d());
  public static final Pose3d BlueAmp =
      new Pose3d(kAmpCols[1], kAmpRow, kAmpHeight, new Rotation3d());

  /**
   * From https://firstfrc.blob.core.windows.net/frc2024/FieldAssets/2024LayoutMarkingDiagram.pdf
   * page 4 Distances are to center of field tag
   */
  public static final ArrayList<Pose3d> AprilTags =
      new ArrayList<Pose3d>() {
        {
          // 1, 2, : Blue source
          add(
              new Pose3d(
  ...
  public static enum TargetType {
    Speaker
  } // TODO: add more targets for better functionality

  public static Pose3d getTargetList(TargetType targetType) {
    Alliance color = DriverStation.getAlliance().get(); // maybe use optional?
    switch (targetType) {
      case Speaker:
        return color == Alliance.Red ? FieldPosition.RedSpeaker : FieldPosition.BlueSpeaker;
    }
    // return FieldPosition.BlueSpeaker;
    return new Pose3d();
  }

  // public IntakeVision.LimelightReadings getIntakeTargetDataOdometry(IntakeVision intakeVision,
  // Pose3d target, SwerveDrivePoseEstimator poseEstimator) {
  ...
  // public ShooterVision.LimelightReadings getShooterTargetDataOdometry(ShooterVision
  // shooterVision, Pose3d target, SwerveDrivePoseEstimator poseEstimator) {
  ...
  public static void ShowOnGlassDashboard(Field2d field) {
    ...
    // Pose2d[] fieldObjects = {RedSpeaker.toPose2d(), BlueSpeaker.toPose2d(), RedAmp.toPose2d(),
    // BlueAmp.toPose2d()};
