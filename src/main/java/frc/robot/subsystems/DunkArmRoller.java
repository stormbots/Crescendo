...
public class DunkArmRoller extends SubsystemBase {
  private CANSparkMax rollerMotor =
      new CANSparkMax(Robot.isCompbot ? 16 : 15, MotorType.kBrushless);
  ...
  public DunkArmRoller() {
    ...
    rollerMotor
        .getEncoder()
        .setVelocityConversionFactor(rollerMotor.getEncoder().getPositionConversionFactor() / 60.0);
  ...
  public void setPosition(double position) {
    ...
    rollerMotor
        .getPIDController()
        .setReference(position, ControlType.kPosition, 0, feedforward, ArbFFUnits.kPercentOut);
  }
